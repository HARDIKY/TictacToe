...
function initLabels() {
  ...
  sizeP = createP('Size: '+boardSize).style('background-color', '#EEE').style('font-size', '20px').style('padding', '10px')
  sizeP.position(width+30, 100);
  
  nameDev =createP('Made by Hardik Yewale').style('background-color', '#EEE').style('font-size', '20px').style('padding', '10px')
  sizeP.position(width+30, 100);
